...
class DashScopeProvider(LLMProvider):
    ...
    def __init__(self, auth_manager: LLMAuthManager = None, model_name: str = None):
        ...
        self._driver = DashScopeModelDriver(type(self).provider_name, self._model_name, self._api_key, self._tool_registry)
...
LLMProviderRegistry.register(DashScopeProvider.provider_name, DashScopeProvider)
