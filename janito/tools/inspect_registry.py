def check_tools_registry():
    ...
    print("Available tool classes:", [cls.__name__ for cls in local_tools_adapter.get_tool_classes()])
    print("Available tool instances:", [tool.name for tool in local_tools_adapter.get_tools()])
