...
class RoleShellHandler(ShellCmdHandler):
    ...
    def run(self):
        ...
        if agent and hasattr(agent, "set_template_var"):
            ...
            if hasattr(agent, 'set_system_using_template') and hasattr(agent, '_system_prompt_template_file') and agent._system_prompt_template_file:
                agent.set_system_using_template(agent._system_prompt_template_file, **agent.template_vars)
